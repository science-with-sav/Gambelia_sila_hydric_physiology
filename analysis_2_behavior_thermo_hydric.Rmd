...
compare boxplots of the same individuals in April/My (avg) vs July to make sure we have no outliers, and if no outliers, what trends look like:
...
What were those lizards like in April?
...
do the same models for April/May data:
...
No carry-over differences from April, which is good!
...
Could also do prop time below ground ~ Davis ws temperature
