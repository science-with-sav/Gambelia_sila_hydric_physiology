...
ggplot(MH_use_across_indivs) + 
  ...
  annotate(geom = "text", x = 1, y = 1.05, label = "A", size = 3) +
  annotate(geom = "text", x = 2, y = 1.05, label = "A", size = 3) +
  annotate(geom = "text", x = 3, y = 1.05, label = "A", size = 3) +
  annotate(geom = "text", x = 4, y = 1.05, label = "A", size = 3) +
  annotate(geom = "text", x = 5, y = 1.05, label = "B", size = 3) +
  annotate(geom = "text", x = 6, y = 1.05, label = "B", size = 3) +
  annotate(geom = "text", x = 7, y = 1.05, label = "C", size = 3) +
  # significance annotation for sex
  annotate(geom = "text", x = 2, y = 1, label = "*", size = 6) +
  annotate(geom = "text", x = 3, y = 1.0, label = "*", size = 6) +
  annotate(geom = "text", x = 4, y = 1.0, label = "*", size = 6) +
  savs_ggplot_theme -> fancy_micro_plot

ggsave(filename = "microhabitat_use.pdf",
       plot = fancy_micro_plot,
