...
# export for study comparison
write_rds(temp_sub, "data/Tb_clean.RDS")
```
...
ggplot() + 
  ...
  scale_fill_manual(values = my_brew_cols_4, 
                    name = "\n\n\n\n\nMicrohabitat", # extra space for lizard pic
  ...
  theme(
    ...
    legend.spacing.y = unit(1, 'mm'), # this affects the space btw title/items
    legend.key.height = unit(4.5, "mm"),
    legend.margin = margin(l = 2, r = 2, t = 1, b = 1, unit = 'mm')
  ) -> fancy_micro_plot
fancy_micro_plot
...
ggsave(filename = "microhabitat_use.pdf",
       plot = fancy_micro_plot, #_arrange,
       path = "./results_figures",
       device = "pdf",
       dpi = 600,
       units = "mm",
