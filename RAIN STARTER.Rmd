...
```{r}
HOBO_temp_lm_og <- lm(data = dat_HOBO_chunks_by_burrow,
...
```{r}
HOBO_RH_lm_og <- lm(data = dat_HOBO_chunks_by_burrow,
...
```{r}
HOBO_VPD_lm_og <- lm(data = dat_HOBO_chunks_by_burrow,
