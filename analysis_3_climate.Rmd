...
ggplot() +
  ...
  annotate(geom = "text", x = 5, y = 37, label = "C", size = 3) +
  annotate(geom = "text", x = 6, y = 37, label = "D", size = 3) +
  annotate(geom = "text", x = 7, y = 37, label = "D", size = 3) +
...
ggplot() +
  ...
  annotate(geom = "text", x = 5, y = 107, label = "AB", size = 3) +
  annotate(geom = "text", x = 6, y = 107, label = "AB", size = 3) +
...
ggplot() +
  ...
  annotate(geom = "text", x = 4, y = 5, label = "BC", size = 3) +
  annotate(geom = "text", x = 5, y = 5, label = "CD", size = 3) +
  annotate(geom = "text", x = 6, y = 5, label = "D", size = 3) +
