...
# F stats
car::Anova(CEWL_cov_check_clotemp, type = "III")
car::Anova(CEWL_cov_check_msmttemp, type = "III")
car::Anova(CEWL_cov_check_VPD, type = "III")
```
...
car::Anova(lm(data = dat,
           CEWL_g_m2h ~ osmolality_mmol_kg_mean*month), type = "III")
summary(lm(data = dat,
           CEWL_g_m2h ~ osmolality_mmol_kg_mean*month*sex_M_F), type = "III")
car::Anova(lm(data = dat,
           CEWL_g_m2h ~ hematocrit_percent), type = "III")
car::Anova(lm(data = dat,
           CEWL_g_m2h ~ mass_g), type = "III")
car::Anova(lm(data = dat,
           CEWL_g_m2h ~ SMI), type = "III")

# osmolality ~
car::Anova(lm(data = dat,
           osmolality_mmol_kg_mean ~ hematocrit_percent), type = "III")
car::Anova(lm(data = dat,
           osmolality_mmol_kg_mean ~ mass_g), type = "III")
car::Anova(lm(data = dat,
           osmolality_mmol_kg_mean ~ SMI), type = "III")

# hct
car::Anova(lm(data = dat,
           hematocrit_percent ~ SMI*sex_M_F), type = "III")
```
...
time_sex_diffs_osml <- lmerTest::lmer(data = dat_repeats, 
                                      osmolality_mmol_kg_mean ~ month*sex_M_F +
                                        (1|individual_ID))
anova(time_sex_diffs_osml, type = "3", ddf = "Kenward-Roger")
...
time_sex_diffs_CEWL <- lmerTest::lmer(data = dat_repeats, 
                                      CEWL_g_m2h ~ month*sex_M_F +
                                        (1|individual_ID))
anova(time_sex_diffs_CEWL, type = "3", ddf = "Kenward-Roger")
...
time_sex_diffs_CEWL_check_covaries <- lmerTest::lmer(data = dat_repeats, 
                                         ...
                                         + msmt_temp_C + msmt_VPD_kPa +
                                        (1|individual_ID))
anova(time_sex_diffs_CEWL_check_covaries, type = "3", ddf = "Kenward-Roger") # not important at all
59/0.09 # 655.5
54/0.14 # 385.7
