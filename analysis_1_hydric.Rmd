...
# osmolality ~
summary(lm(data = dat,
           osmolality_mmol_kg_mean ~ hematocrit_percent*month*sex_M_F))
summary(lm(data = dat,
...
ggplot() +
  ...
  # time differences for MALES
  annotate(geom = "text", x = 2, y = 19, label = "AB", size = 3) +
  annotate(geom = "text", x = 4, y = 19, label = "A", size = 3) +
  annotate(geom = "text", x = 6, y = 19, label = "B", size = 3) +
  # time differences for FEMALES
...
--Then, I should work on the written methods again.
