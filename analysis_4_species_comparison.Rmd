...
Because there are so few data measuring CEWL with the same methods we use, we decided to compare BNLL to Western Fence Lizards (*Sceloporus occidentalis*) that we've measured using the exact same methods.
...
This is from the experiment I ran summer 2021 (published in JEB in 2023).
